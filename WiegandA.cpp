...
volatile unsigned long WIEGAND_A::_cardTempHigh=0;
volatile unsigned long WIEGAND_A::_cardTemp=0;
volatile unsigned long WIEGAND_A::_lastWiegand=0;
unsigned long WIEGAND_A::_code=0;
volatile int WIEGAND_A::_bitCount=0;	
int WIEGAND_A::_wiegandType=0;
static char translateEnterEscapeKeyPress(char originalKeyPress);
WIEGAND_A::WIEGAND_A()
{
}

unsigned long WIEGAND_A::getCode()
{
	return _code;
}

int WIEGAND_A::getWiegandType()
{
	return _wiegandType;
}

bool WIEGAND_A::available()
{
	bool ret;
	noInterrupts();
...
void WIEGAND_A::begin()
{
	begin(2,3);
}

void WIEGAND_A::begin(int pinD0, int pinD1)
{
	_lastWiegand = 0;
	_cardTempHigh = 0;
	_cardTemp = 0;
	...
	attachInterrupt(digitalPinToInterrupt(pinD0), ReadDA0, FALLING);  // Hardware interrupt - high to low pulse
	attachInterrupt(digitalPinToInterrupt(pinD1), ReadDA1, FALLING);  // Hardware interrupt - high to low pulse
}

INTERRUPT_ATTR void WIEGAND_A::ReadDA0 ()
{
...
INTERRUPT_ATTR void WIEGAND_A::ReadDA1()
{
...
unsigned long WIEGAND_A::GetCardId (volatile unsigned long *codehigh, volatile unsigned long *codelow, char bitlength)
{
...
bool WIEGAND_A::DoWiegandConversion ()
{
