...
volatile unsigned long WIEGAND_B::_cardTempHigh=0;
volatile unsigned long WIEGAND_B::_cardTemp=0;
volatile unsigned long WIEGAND_B::_lastWiegand=0;
unsigned long WIEGAND_B::_code=0;
volatile int WIEGAND_B::_bitCount=0;  
int WIEGAND_B::_wiegandType=0;
static char translateEnterEscapeKeyPress(char originalKeyPress);
WIEGAND_B::WIEGAND_B()
{
}

unsigned long WIEGAND_B::getCode()
{
  return _code;
}

int WIEGAND_B::getWiegandType()
{
  return _wiegandType;
}

bool WIEGAND_B::available()
{
  bool ret;
  noInterrupts();
...
void WIEGAND_B::begin()
{
  begin(2,3);
}

void WIEGAND_B::begin(int pinD0, int pinD1)
{
  _lastWiegand = 0;
  _cardTempHigh = 0;
  _cardTemp = 0;
...
INTERRUPT_ATTR void WIEGAND_B::ReadD0 ()
{
...
INTERRUPT_ATTR void WIEGAND_B::ReadD1()
{
...
unsigned long WIEGAND_B::GetCardId (volatile unsigned long *codehigh, volatile unsigned long *codelow, char bitlength)
{
...
bool WIEGAND_B::DoWiegandConversion ()
{
